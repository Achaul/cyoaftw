...
const SEX_ACTS = {
    ...
    tongue_pussy: { id: "tongue_pussy", tool: "tongue", target: "vagina", verb: "penetrate", type: ACT_TYPES.TEASE, label: "Tongue fuck", desc: "Penetrate their pussy with your tongue", arousal: { p: 15, n: 65 }, pos: ["Standing", "Perched", "Missionary", "Astride Lap", "Kneeling Over"], reqCloth: CLOTHING_REQUIREMENTS.BOTTOM_OFF, requiresPrior: ["lick_pussy", "eat_pussy"], requiresNpcFemale: true },
    suck_clit: { id: "suck_clit", tool: "mouth", target: "clitoris", verb: "suck", type: ACT_TYPES.TEASE, label: "Suck clit", desc: "Suck on their clitoris", arousal: { p: 10, n: 60 }, pos: ["Standing", "Perched", "Missionary", "Astride Lap", "Kneeling Over", "Sixty-Nine", "Kneeling", "Kneeling Over", "Oral Service", "Prone Oral Service", "Squatting Before"], reqCloth: CLOTHING_REQUIREMENTS.BOTTOM_OFF, requiresPrior: ["lick_pussy", "eat_pussy"], requiresNpcFemale: true },
    ...
    press_penis_pussy: { id: "press_penis_pussy", tool: "penis", target: "vagina", verb: "press", type: ACT_TYPES.TEASE, label: "Press against pussy", desc: "Press your penis against their pussy", arousal: { p: 20, n: 50 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresPrior: ["rub_pussy", "tease_pussy", "finger_pussy"], maleOnly: true, requiresNpcFemale: true },
    enter_pussy: { id: "enter_pussy", tool: "penis", target: "vagina", verb: "enter", type: ACT_TYPES.PENETRATE, label: "Enter pussy", desc: "Enter their pussy", arousal: { p: 30, n: 80 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["press_penis_pussy", "finger_pussy", "enter_pussy_finger"], takesVirginity: [VIRGINITY_TYPES.VAGINAL], maleOnly: true, requiresNpcFemale: true },
    thrust_pussy: { id: "thrust_pussy", tool: "penis", target: "vagina", verb: "thrust", type: ACT_TYPES.CONTINUE, label: "Thrust into pussy", desc: "Thrust your penis into their pussy", arousal: { p: 25, n: 70 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["enter_pussy"], maleOnly: true, requiresNpcFemale: true },
    pump_pussy: { id: "pump_pussy", tool: "penis", target: "vagina", verb: "pump", type: ACT_TYPES.CONTINUE, label: "Pump into pussy", desc: "Pump in and out of their pussy", arousal: { p: 25, n: 75 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["enter_pussy", "thrust_pussy"], intensity: "medium", maleOnly: true, requiresNpcFemale: true },
    fuck_pussy: { id: "fuck_pussy", tool: "penis", target: "vagina", verb: "fuck", type: ACT_TYPES.CONTINUE, label: "Fuck pussy", desc: "Fuck their pussy", arousal: { p: 30, n: 80 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["enter_pussy", "thrust_pussy"], intensity: "hard", maleOnly: true, requiresNpcFemale: true },
    pound_pussy: { id: "pound_pussy", tool: "penis", target: "vagina", verb: "pound", type: ACT_TYPES.CONTINUE, label: "Pound pussy", desc: "Pound into their pussy hard", arousal: { p: 35, n: 85 }, pos: ["Doggy", "Bent Over", "Standing From Behind", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["enter_pussy", "thrust_pussy"], intensity: "hard", maleOnly: true, requiresNpcFemale: true },
    ...
    // V on P
    impale_penis: { id: "impale_penis", tool: "vagina", target: "penis", verb: "impale", type: ACT_TYPES.PENETRATE, label: "Impale on penis", desc: "Impale yourself on their penis", arousal: { p: 25, n: 70 }, pos: ["Cowgirl", "Reverse Cowgirl", "Astride Lap"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, takesVirginity: [VIRGINITY_TYPES.VAGINAL], playerIsBottom: true, femaleOnly: true, requiresNpcMale: true },
    ride_penis: { id: "ride_penis", tool: "vagina", target: "penis", verb: "ride", type: ACT_TYPES.CONTINUE, label: "Ride penis", desc: "Ride their penis", arousal: { p: 25, n: 75 }, pos: ["Cowgirl", "Reverse Cowgirl", "Astride Lap"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["impale_penis"], femaleOnly: true, requiresNpcMale: true },
    bounce_penis: { id: "bounce_penis", tool: "vagina", target: "penis", verb: "bounce", type: ACT_TYPES.CONTINUE, label: "Bounce on penis", desc: "Bounce up and down on their penis", arousal: { p: 30, n: 80 }, pos: ["Cowgirl", "Reverse Cowgirl", "Astride Lap"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["impale_penis", "ride_penis"], intensity: "medium", femaleOnly: true, requiresNpcMale: true },
    grind_penis: { id: "grind_penis", tool: "vagina", target: "penis", verb: "grind", type: ACT_TYPES.CONTINUE, label: "Grind on penis", desc: "Grind your hips on their penis", arousal: { p: 20, n: 65 }, pos: ["Cowgirl", "Reverse Cowgirl", "Astride Lap"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["impale_penis"], femaleOnly: true, requiresNpcMale: true },
    
    // NEW: Priority 2 - Vaginal on penis continue action
    squeeze_cock: { id: "squeeze_cock", tool: "vagina", target: "penis", verb: "squeeze", type: ACT_TYPES.CONTINUE, label: "Squeeze cock", desc: "Squeeze their cock with your pussy", arousal: { p: 30, n: 70 }, pos: ["Cowgirl", "Reverse Cowgirl", "Astride Lap", "Missionary", "Standing", "Standing From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["impale_penis", "enter_pussy"], intensity: "medium", femaleOnly: true, requiresNpcMale: true },
    ...
    cocktease_with_ass: { id: "cocktease_with_ass", tool: "anus", target: "penis", verb: "tease", type: ACT_TYPES.TEASE, label: "Tease cock with ass", desc: "Tease their cock with your anus", arousal: { p: 25, n: 50 }, pos: ["Standing From Behind", "Doggy", "Bent Over", "Missionary", "Spooning", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.BOTTOM_OFF, requiresPrior: ["press_penis_anus", "finger_anus"], requiresNpcMale: true },
    ...
    take_penis_anus: { id: "take_penis_anus", tool: "anus", target: "penis", verb: "take", type: ACT_TYPES.CONTINUE, label: "Take penis in anus", desc: "Take their penis deeper into your anus", arousal: { p: 35, n: 30 }, pos: ["Standing From Behind", "Doggy", "Bent Over", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, requiresPrior: ["accept_penis_anus"], requiresNpcMale: true },
    
    // NEW: Priority 2 - Hump Ass Back Onto Cock (reverse anal penetration)
    hump_ass_back_onto_cock: { id: "hump_ass_back_onto_cock", tool: "anus", target: "penis", verb: "hump", type: ACT_TYPES.PENETRATE, label: "Hump ass onto cock", desc: "Back your ass onto their cock", arousal: { p: 40, n: 30 }, pos: ["Standing From Behind", "Doggy", "Bent Over", "Against Wall From Behind"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, requiresLube: true, takesVirginity: [VIRGINITY_TYPES.ANAL], playerIsBottom: true, requiresPrior: ["cocktease_with_ass", "press_penis_anus"], requiresNpcMale: true },
    ...
    pull_off: { id: "pull_off", type: ACT_TYPES.END, label: "Pull off", desc: "Pull your pussy off their penis", arousal: { p: 0, n: 0 }, pos: ["Standing", "Standing From Behind", "Missionary", "Doggy", "Bent Over", "Against Wall", "Against Wall From Behind", "Cowgirl", "Reverse Cowgirl"], reqCloth: CLOTHING_REQUIREMENTS.NUDE, playerIsBottom: true, requiresPrior: ["enter_pussy", "thrust_pussy", "fuck_pussy", "pump_pussy"], femaleOnly: true, requiresNpcMale: true },
    ...
    frot: { id: "frot", tool: "penis", target: "penis", verb: "frot", type: ACT_TYPES.TEASE, label: "Frot", desc: "Rub your cock against their cock", arousal: { p: 25, n: 25 }, pos: ["Standing", "Standing From Behind", "Perched"], reqCloth: CLOTHING_REQUIREMENTS.BOTTOM_OFF, maleOnly: true, requiresNpcMale: true, requiresPrior: ["stroke_penis", "grip_penis"] },
    
    // F2F: Trib (vulva-to-vulva rubbing)
    trib: { id: "trib", tool: "vagina", target: "vagina", verb: "trib", type: ACT_TYPES.TEASE, label: "Trib", desc: "Rub your pussy against their pussy", arousal: { p: 25, n: 25 }, pos: ["Standing", "Perched", "Missionary", "Astride Lap", "Cowgirl"], reqCloth: CLOTHING_REQUIREMENTS.BOTTOM_OFF, femaleOnly: true, requiresNpcFemale: true, requiresPrior: ["rub_pussy", "grind_pussy"] },
